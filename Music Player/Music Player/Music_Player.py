# All items in the following address are fully explained :
# https://github.com/farzadmohseni-ir
...
main_application.title('MP3 Player')
main_application.geometry('600x600')
main_application.wm_iconbitmap('MP3 Player.ico')

status_bar_label = ttk.Label(main_application, text = 'Welcome To MP3 Player', relief = GROOVE, borderwidth = 2, font = ('Times New Roman', 15, 'italic'))
...
play_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/play.png')
stop_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/stop.png')
pause_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/pause.png')
openfile_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/file.png')
openfolder_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/folder.png')
exit_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/exit.png')
increase_volume_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/increase_volume.png')
decrease_volume_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/decrease_volume.png')
mute_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/mute.png')
playlist_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/playlist.png')
about_us_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/about_us.png')
music_player_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/MP3 Player.png')
main_frame_music_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/main_frame_music.png')
volume_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/volume.png')
mute_resize_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/mute_resize.png')
plus_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/plus.png')
forward_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/forward.png')
backward_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/backward.png')
next_song_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/next_song.png')
previous_song_icon = PhotoImage(file = 'E:/Music Player/Music Player/icon/previous_song.png')
